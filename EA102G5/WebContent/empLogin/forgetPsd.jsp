...
<html lang="zh_TW">
  <head>
    ...
    <link rel="stylesheet" href="../assets/css/color-option9.css" id="option_style">
...
<!--                     <li class="active"><a href="lost-password.html">Password Recovery</a></li> -->
          ...
          <div class="row justify-content-center">
            <div class="col-md-6 col-sm-12">
              <div class="panel panel-default">
                <div class="panel-heading"><h3>忘記密碼惹~~姆咪(QAQ</h3></div>
                <div class="panel-body">
                
                  <form method="POST" action ="empLogin" role="form">
                    <p class="help-block">忘記密碼？哈哈 笑死，再金魚腦啊！把密碼設得跟PornHub帳號的密碼一樣不就好了？我們管理員都這樣設密碼的，小訣竅分享給你，不用謝了！</p>
                    <div class="form-group">
                      <label class="font-weight-bold" for="">輸入員工編號啦!</label>
						<input type="text" class="form-control" name="empNo" id="">    
                                        
                      <label class="font-weight-bold" for="">輸入Email啦!</label>                      
                      <input type="email" class="form-control" name="inputEmail" id="">                     
                    </div>
                    <input type="hidden" name="action" value="inputEmail">
