      ...
      <section class="mainContent clearfix userProfile">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <div class="btn-group" role="group" aria-label="...">
                <a href="fmarticle.jsp" class="btn btn-default"><i class="fa fa-th" aria-hidden="true"></i>所有總類</a>
                <a href="fmarticle301.jsp" class="btn btn-default"><i class="fa fa-th" aria-hidden="true"></i>電玩遊戲</a>
                <a href="fmarticle302.jsp" class="btn btn-default active"><i class="fa fa-th" aria-hidden="true"></i>玩具</a>
