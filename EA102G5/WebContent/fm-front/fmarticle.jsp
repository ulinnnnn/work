...
// 	String fmcl_no = "301";
    List<fmarticleVO> list = fmSvc.getAll();
      ...
      <section class="mainContent clearfix userProfile">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <div class="btn-group" role="group" aria-label="...">
                <a href="fmarticle.jsp" class="btn btn-default active"><i class="fa fa-th" aria-hidden="true"></i>所有總類</a>
                <a href="fmarticle301.jsp" class="btn btn-default"><i class="fa fa-th" aria-hidden="true"></i>電玩遊戲</a>
                <a href="fmarticle302.jsp" class="btn btn-default"><i class="fa fa-th" aria-hidden="true"></i>玩具</a>
                <a href="fmarticle303.jsp" class="btn btn-default"><i class="fa fa-th" aria-hidden="true"></i>各類收藏</a>
                <a href="fmarticle304.jsp" class="btn btn-default"><i class="fa fa-th" aria-hidden="true"></i>開箱分享</a>
                <a href="fmarticle305.jsp" class="btn btn-default"><i class="fa fa-th" aria-hidden="true"></i>其他</a>
                <a href="fmarticle306.jsp" class="btn btn-default"><i class="fa fa-th" aria-hidden="true"></i>尋物</a>
              </div>
            </div>
          </div>
                      ...
                      <tbody >
                        <tr>
                          ...
                          <td><fmt:formatDate value="${fmarticleVO.fm_ti}" pattern="yyyy-MM-dd EEE"/></td>
						     ...
						     <button type="submit"  value="送出新增"  onclick="location.href='NewFile.jsp?${fmarticleVO.fm_no}'" class="btn btn-primary btn-block" style="border-radius: 15px !important">進入</button>
...
<%-- 	  <li><a href='<%=request.getContextPath()%>/fm-front/mybp.jsp'>Add</a>查M0001會員全部</li> --%>
	  ...
	  <button type="submit"  value="送出新增" onclick="location.href='fmins.jsp'" class="btn btn-primary btn-block" style="border-radius: 15px !important">刊登文章</button>
	</ul>
	</div>
	</div>
	</div>
