...
.bg-gradient-primary {
    background: rgba(0,0,0,0.85) linear-gradient(180deg,rgba(0,0,0,0.85),rgba(0,0,0,0.85)) repeat-x!important;
}
								...
								<form role="form" method=post action="func">
									<div class="card-body">
										<div class="form-group">
											<label for="exampleInputEmail1">編號</label>
											<p>${funcVO.funcNo}</p>
										</div>
										<div class="form-group">
											<label for="exampleInputPassword1">權限名稱</label> <input
												type="text" class="form-control" name="funcName"
												value="${funcVO.funcName}">
										</div>
										<div class="form-group">
											<label for="exampleInputPassword1">內容概述</label> <input
												type="text" class="form-control" name="funcDesc"
												value="${funcVO.funcDesc}">
										</div>
