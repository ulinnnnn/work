    ...
    <div class="wrapper">
        ...
        <aside class="left-sidebar sidebar-dark" id="left-sidebar">
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand">
              <a href="/index.html">
                <img src="assets2/img/logo.png" alt="Mono">
                ...
                <ul class="nav navbar-nav">
                        ...
                        <div class="tab-content" id="myTabContent">
                          ...
                          <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tabs">
                            ...
                            <div class="media media-sm bg-warning-10 p-4 mb-0">
                              <div class="media-sm-wrapper">
                                <a href="user-profile.html">
                                  <img src="assets2/img/user/user-sm-02.jpg" alt="User Image">
                                </a>
                              </div>
                            ...
                            <div class="media media-sm p-4 mb-0">
                              <div class="media-sm-wrapper">
                                <a href="user-profile.html">
                                  <img src="assets2/img/user/user-sm-03.jpg" alt="User Image">
                                </a>
                              </div>
                              <div class="media-body">
                                <a href="user-profile.html">
                          ...
                          <div class="tab-pane fade" id="message" role="tabpanel" aria-labelledby="message-tab">
                            ...
                            <div class="media media-sm p-4 mb-0">
                              <div class="media-sm-wrapper">
                                <a href="user-profile.html">
                                  <img src="assets2/img/user/user-sm-01.jpg" alt="User Image">
                                </a>
                              </div>
                              <div class="media-body">
                                <a href="user-profile.html">
                            ...
                            <div class="media media-sm p-4 mb-0">
                              <div class="media-sm-wrapper">
                                <a href="user-profile.html">
                                  <img src="assets2/img/user/user-sm-04.jpg" alt="User Image">
                                </a>
                              </div>
                              <div class="media-body">
                                <a href="user-profile.html">
                  ...
                  <li class="dropdown user-menu">
                    <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                      <img src="assets2/img/user/user-xs-01.jpg" class="user-image rounded-circle" alt="User Image" />
...
<div class="card card-default">
  <div class="px-6 py-4">
    <p>歡迎使用Toy Hot 玩具交換功能<span class="text-secondary text-capitalize"> 使用者名稱 </span> 接下來請填寫交換玩具的表單，我們將遞送給完 <a class="font-weight-bold" href="https://getbootstrap.com/docs/4.3/components/forms/" target="_blank"> 平台刊登方</a></p>
  </div>
</div>
...
&lt;/form&gt;
        ...
        <form METHOD="post" ACTION="Cproduct.do" name="form1" enctype ="multipart/form-data">
          <div class="form-group">
            <label for="exampleFormControlInput2">玩具名稱</label>
            <input name="cpname"  type="text" class="form-control" id="exampleFormControlInput2" placeholder="20字以內">
            <span class="mt-2 d-block">此申請交換不經審查，如若包含不雅字而遭會員檢舉將依相關規定停權</span>
          </div>
          
          <div class="form-group">
          <jsp:useBean id="CpclassSvc" scope="page" class="com.cpclass.model.CpclassService" />

		       <label for="exampleFormControlSelect12">商品類別</label>
    ...
    <select  name="cpmeetup2"   class="district"></select>
          ...
          <div class="form-group">
            ...
            <textarea name="cptext" class="form-control" id="exampleFormControlTextarea1" required rows="3" placeholder="200字以內相關商品描述">${param.cptext}</textarea>
          </div>
          <div class="form-group">
            <label for="exampleFormControlFile1">商品圖片，最多三張</label>
            <input type="file" class="form-control-file" onchange="showImg(this)"accept="image/gif, image/jpeg, image/png" name="pic1" id="exampleFormControlFile1">
            <input type="file" class="form-control-file" onchange="showImg(this)"accept="image/gif, image/jpeg, image/png" name="pic2" id="exampleFormControlFile1">
            <input type="file" class="form-control-file" onchange="showImg(this)"accept="image/gif, image/jpeg, image/png" name="pic3" id="exampleFormControlFile1">
             <div>
                    ...
                    <div class="card card-offcanvas" id="contact-off" >
                      ...
                      <div class="card-body">
                        ...
                        <div class="media media-sm">
                          <div class="media-sm-wrapper">
                            <a href="user-profile.html">
                              <img src="assets2/img/user/user-sm-05.jpg" alt="User Image">
                        ...
                        <div class="media media-sm">
                          <div class="media-sm-wrapper">
                            <a href="user-profile.html">
                              <img src="assets2/img/user/user-sm-06.jpg" alt="User Image">
                              <span class="active bg-primary"></span>
                            </a>
                          </div>
                          <div class="media-body">
