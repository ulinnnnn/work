            ...
            <div class="col-md-7 col-lg-8 col-xl-7 col-12">
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <form  method="POST" role="form" ACTION="<%= request.getContextPath() %>/front_end/mem.do" enctype="multipart/form-data" >
                    <div class="form-group">
                      
                      <label for="">Account</label>
                      
                      <input type="text"name="mem_account" class="form-control" id="">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password"name="mem_pwd" class="form-control" id="">
                    ...
                    <button type="submit" class="btn btn-primary btn-default btn-block">log in</button>
                    <div class="d-block social-login text-center">
                      ...
                      <button class="btn btn-social titled google-plus float-lg-right">
