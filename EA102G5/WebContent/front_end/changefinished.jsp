          ...
          <div class="row">
            <div class="col-md-12">
              <div class="thanksContent">
                <h2>感謝您使用交換功能，交換已完成<small>本資料將封存，如若無故不履行交易將依相關會員規定處置</small></h2>
                <a href="readrecord.jsp" class="btn btn-default  active"><h3>回到交換紀錄</h3></a>
                <div class="thanksInner">
                  <div class="row">
                    <div class="col-md-6 tableBlcok">
                      <address>
                              <a class="addreport" href="#">本平台僅作為第三方平台，如有無故不履行交換或其他交換糾紛請至交換紀錄進行回報</a> <br>
